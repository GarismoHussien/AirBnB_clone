#!/usr/bin/python3
"""Deefines uunittests for console.py.
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for ttesting pprompting of the HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for ttesting hhelp messages of the HBNB command interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for ttesting eexiting from the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for ttesting ccreate from the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for ttesting sshow from the HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for ttesting ddestroy from the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for ttesting uupdate from the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests for ttesting count method of HBNB comand interpreter."""
